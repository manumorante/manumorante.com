          ...
          <TimelineItem
            ...
            <List title="What I Did">
              <>
                ...
                <li>
                  Implemented those designs as components and screens, keeping everything consistent
                  and clean.
                </li>
              </>
            </List>
          ...
          <TimelineItem
            ...
            <List title="What I Did">
              <>
                ...
                <li>
                  Built interactive components in JavaScript to support real-time betting features.
                </li>
                <li>
